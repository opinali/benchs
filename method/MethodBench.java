 ...
 *
 * This is technically a microbenchmark (tested code is minimal), but we make a lot of effort to
 * prevent "excessive" optimizations that would make results irrelevant or hard to analyse. The
 * techniques are apparently very successfull for the current crop of JITs.
 *
