/**
 * "Hard" test: Uses values not compilt-time computable for loop bounds, making things harder for
 * loop optimizations (favors profile-driven compilers).
 *
...
public class MethodHard extends MethodBench {
  ...
  /**
   * Unoptimizable constant for the loop's max bound.
   */
  static final int CALLS = Integer.parseInt("100000000");

  /**
   * Unoptimizable constant for the loops' lower bounds.
   */
  static final int ZERO = Integer.parseInt("0");

  /**
   * Unoptimizable constant for the benchmark controller's loop.
   */
